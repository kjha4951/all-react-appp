  ...
  return (
    <>
     ...
     <div className='flex flex-col items-center justify-center'>
      ...
      className='block border p-3 text-sm focus:border-gray-300 rounded w-1/2 my-5 ' type="text"  placeholder='Search'/>
      ...
      <table className='w-1/2 text-left border-collapse border border-gray-300'>
        ...
        <tbody>
          ...
          {/* <tr>
            <td className='p-3 border border-gray-300'>Komal</td>
            <td className='p-3 border border-gray-300'>Jha</td>
            <td className='p-3 border border-gray-300'>qG9oA@example.com</td>
            <td className='p-3 border border-gray-300'>1234567890</td>
            <td className='p-3 border border-gray-300'>Female</td>
